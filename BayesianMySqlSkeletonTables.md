...
MySql SQL to be used when creating skeleton tables for bayesianmysql. Wiki page BayesianMySql.


# Details #

This MySql SQL is used for building skeleton tables for Bayesian-MySql. Create database named bayesianmysql before executing.
